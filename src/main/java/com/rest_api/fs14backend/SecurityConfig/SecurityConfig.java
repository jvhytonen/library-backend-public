...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/books/", "api/v1/authors/", "/api/v1/signup", "/api/v1/book-copies/{id}", "/api/v1/signin")
                .permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/images/upload/").hasRole("ADMIN")
